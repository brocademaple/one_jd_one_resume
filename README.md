...
一个支持多模型的智能求职系统，帮助用户根据岗位 JD 生成专业定制简历，并提供面试辅导。
...
- **简历导出** — 支持 PDF 和 Word 格式导出，并可放大预览
- **文件管理** — 管理多个岗位对应的多版本简历
...
├──────────┬───────────────────┬───────────────────┬────────────────────┤
│          │                   │                   │                    │
│  侧边栏  │    岗位 JD 面板   │   简历内容面板    │   Agent 对话面板   │
│          │                   │                   │                    │
│ ▸ 岗位A  │  # 高级前端工程师 │  # 张三           │  🤖 我是简历定制   │
│   └简历1 │                   │  ---              │     助手...        │
│   └简历2 │  ## 岗位要求      │  ## 工作经历      │                    │
│ ▸ 岗位B  │  - React 3年以上  │  字节跳动 2021-   │  👤 帮我生成简历   │
│   └简历1 │  - 熟悉性能优化   │  负责...          │                    │
│          │                   │                   │  🤖 好的，根据     │
│ [新建]   │  ## 薪资          │  ## 教育背景      │     您的JD...      │
│          │  25-40K           │  清华大学 2018    │                    │
│ ⚙ 模型  │                   │                   │  [导出PDF] [.md]   │
│ DeepSeek │  [编辑]           │  [编辑] [导出▾]   │  _______________   │
│          │                   │                   │  > 发送消息...  ➤  │
└──────────┴───────────────────┴───────────────────┴────────────────────┘
```
...
│                                                                 │
│  ┌──────────┐  ┌────────────┐  ┌────────────┐  ┌───────────┐  │
│  │ Sidebar  │  │  JD Panel  │  │Resume Panel│  │Chat Panel │  │
...
│  /api/export ► ExportRouter    ──► ReportLab PDF               │
...
1. **新建岗位** — 点击左侧「新建岗位」，粘贴岗位 JD
2. **填写背景** — 对话面板点击「我的背景」浮窗，支持文本/PDF/Word/图片 OCR 上传
3. **生成简历** — 发送「帮我生成一份针对该 JD 的简历」
4. **优化迭代** — 继续对话，要求 Agent 调整具体内容
5. **面试辅导** — 发送「给我针对该岗位的面试技巧」
6. **导出简历** — 简历面板右上角「导出」→ 选择 PDF 或 Markdown
